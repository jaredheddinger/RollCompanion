//
//  CharacterBuildView.swift
//  Roll Companion (Swift)
//
//  Created by Jared Heddinger on 2/16/20.
...
class CharacterBuildView: UITableViewController, UIPickerViewDataSource, UIPickerViewDelegate {
...
//        self.tableView.insertRows(at: [insertIndex], with: .bottom)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?)  {
        if (segue.identifier == "SaveCharacter") {
            ...
            let character = NSManagedObject(entity: characterEntity, insertInto: managedContext) as? Character1
